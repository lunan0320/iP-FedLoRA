...
def select_public_and_test_features(valid_features_all, test_features_all):
    if valid_features_all is test_features_all:
        raise ValueError("public and test features must be distinct objects")
    return valid_features_all, test_features_all
...
class BaseDataLoader(ABC):
    ...
    def _load_federated_data_on_client(self):
        ...
        public_features, test_features = select_public_and_test_features(
            valid_features_all, test_features_all
        )
        self.test_dataloader = self.build_dataloader(test_features, "test")
        self.public_train_dataloader = self.build_dataloader(
